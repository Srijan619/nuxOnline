...
const { state, updateKnobValue } = useNUXMidiController();
</script>
  ...
  <div class="knob-container">
    ...
    >
      <TwoWaySwitch
        ...
        @update:value="(value) => updateKnobValue(knob?.ctrl, value ? 1 : 0)"
      />
      <KnobControl
        v-else
        :title="knob.title"
        ...
        @update:value="(value) => updateKnobValue(knob?.ctrl, value)"
