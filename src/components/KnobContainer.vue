...
const { selectedEffectOption, selectedEffectConfig } = state;
...
<template>
  <div class="knob-container">
    <template
      v-for="knob in selectedEffectOption.knobs"
    ...
    >
      <TwoWaySwitch
        ...
        :id="knob.id"
        :title="knob.title"
        :activeColor="selectedEffectConfig?.categoryColor"
      ...
      <KnobControl
        ...
        :sliderFillColor="selectedEffectConfig?.categoryColor"
      />
    </template>
  </div>
</template>
